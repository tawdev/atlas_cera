...
<head>
    ...
    <meta name="description" content="Galerie Photos - Atlas Cera - Nos réalisations en construction, rénovation et décoration.">
    <title>Galerie | Atlas Cera</title>
...
<body>
    ...
    <div class="gallery-page">
        <div class="gallery-page-header">
            <p class="eyebrow">Galerie Photos</p>
            <h1>Nos Réalisations en Images</h1>
            <p>Découvrez nos projets de construction, rénovation et décoration à travers le Maroc</p>
        </div>
        ...
        <div class="gallery-page-container">
            ...
            <?php else: ?>
                <div class="gallery-page-empty">
                    ...
                    <p>La galerie sera bientôt mise à jour avec nos dernières réalisations.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="gallery-lightbox" id="galleryLightbox">
        <button class="gallery-lightbox-close" id="galleryLightboxClose" aria-label="Fermer">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                <line x1="18" y1="6" x2="6" y2="18"></line>
                <line x1="6" y1="6" x2="18" y2="18"></line>
            </svg>
        </button>
        <button class="gallery-lightbox-nav gallery-lightbox-prev" id="galleryLightboxPrev" aria-label="Image précédente">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="15 18 9 12 15 6"></polyline>
            </svg>
        </button>
        <button class="gallery-lightbox-nav gallery-lightbox-next" id="galleryLightboxNext" aria-label="Image suivante">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
